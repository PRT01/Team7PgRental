                ...
                <div class="row align-items-center justify-content-center h-100 g-0">
                    <div class="col col-sm-6 col-lg-7 col-xl-6">
                        ...
                        <a href="#" class="d-flex justify-content-center mb-1">
                            <img src="images/buildings.png" alt="" width="50"
                        ...
                        <!-- <div class="input-group justify-content-center mb-3">
                            <div class="form-check form-check-inline align-items-center">
                                <input class="form-check-input" type="radio" name="userType" id="pgOwnerRadio" value="pgOwner" onchange="toggleAadhaarField()" required >
                                <label class="form-check-label mb-0" for="pgOwnerRadio">PG Owner</label>
                            </div>
                            <div class="form-check form-check-inline align-items-center">
                                <input class="form-check-input" type="radio" name="userType" id="userRadio" value="user" onchange="toggleAadhaarField()" checked required>
                        ...
                        <div class="input-group justify-content-center mb-3">
                            ...
                            <input type="text" name="name" class="form-control fs-6" placeholder="Full Name" required>
                        </div>
                        <!-- Email input field -->
                        <div class="input-group justify-content-center mb-3">
                            <span class="input-group-text">
                        ...
                        <div class="input-group justify-content-center mb-3">
                            ...
                            <select name="gender" class="form-select fs-6">
                        ...
                        <div class="input-group justify-content-center mb-3" >
                            ...
                            <input type="password" name="pass" id="pass" class="form-control fs-6"
                        ...
                        <div class="input-group justify-content-center mb-3">
                            ...
                            <input type="password" name="re_pass" id="re_pass" class="form-control fs-6"
                        ...
                        <div class="input-group justify-content-center mb-3">
                            ...
                            <input type="text" name="mobile" class="form-control fs-6" placeholder="Mobile Number" required>
                        </div>
                        <!-- Sign Up button -->
