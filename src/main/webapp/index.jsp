...
<body>
        ...
        <div class="d-flex">
            <div class="dropdown">
                ...
                <div class="dropdown-menu" aria-labelledby="dropdownMenuLink">
                 ...
                 <button class="btn btn-danger pg-btn" type="button"  onclick="window.location.href='PG'">
                ...
                <div class="flip-card">
                    <div class="flip-card-inner">
                        ...
                        <div class="flip-card-back">
                            ...
                            <p class="text-justify text-center" style="font-size:10px; color: #F3F4F5;;">Our 2-share rooms
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col">
                <p class=".lead h6 text-justify mt-4 ml-2 text-capitalize"> It includes Contact insformation such as email address,phone
                ...
                <i class="fa-solid fa-envelope mt-2 ml-2">
                    <p class=".lead h6 ml-4" style="margin-top: -15px;font-size: 10px;letter-spacing: 2px;">Amulayagrandmenspg@gmail.com</p>
                </i>
            ...
            <div class="col mt-5 mr-5" style="position: relative;right: 200px;top: 12px;">
                ...
                <i class="fa-solid fa-location-dot">
                    <p class=".lead h6 ml-4 " style="margin-top: -15px;font-size: 12px; letter-spacing: 2px;">H.No 2-54/C/3, P.J.R. 500032, Gachibowli, Telangana,Amulya mens pg</p>
                </i>

                <img class="img-fluid" style="width: 80%;position: relative;left: 350px;top: -290px;box-shadow: 0 4px 8px 0 rgba(0, 0, 0, 0.2), 0 6px 20px 0 rgba(0, 0, 0, 0.19);border-radius: 20px;" src="./images/loaction.png" alt="">
            </div>
        </div>
    </div>
    ...
    <div class="container">
        <div class="row">
            <div class="col mt-5" >
                ...
                <ul><li><a href="">Become a Customer</a></li></ul>
                <ul><li><a href="">About Us</a></li></ul>
                <ul><li><a href="">FAQ</a></li></ul>
                <ul><li><a href="">Return Policy</a></li></ul>
                <ul><li><a href="">Contact Us</a></li></ul>
            </div>
            <div class="col mt-5">
                <h2 class="ml-2" style="margin-top: 6px; color:#F3F4F5;">Language</h2>
                <ul><li><a href="">English</a></li></ul>
                <ul><li><a href="">Telugu</a></li></ul>
                <ul><li><a href="">Hindi</a></li></ul>
            </div>
            <div class="col mt-5">
                <h2 class="ml-2" style="margin-top: 6px; color:#F3F4F5;">Get in touch</h2>
               <div class="icons">
                <ul><li><i class="fa-brands fa-facebook"></i></li></ul>
                <ul><li><i class="fa-brands fa-square-twitter"></i></li></ul>
                <ul><li><i class="fa-brands fa-linkedin"></i></li></ul>
               </div>
            </div>
        </div>
    </div>
