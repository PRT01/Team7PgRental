...
<input type="hidden" name="status" id="status" value="<%= request.getAttribute("status") %>">
    ...
    <div class="row vh-100 g-0">
        ...
        <div class="col-lg-6 position-relative d-none d-lg-block">
                <img src="images/img log.jpg" style="box-shadow: 0 4px 8px 0 rgba(0, 0, 0, 0.2), 0 6px 20px 0 rgba(0, 0, 0, 0.19);border-radius:0 30px 30px 0" class="bg-holder" alt="">
        </div>
        <!-- / Left Side -->
        <!-- Right Side -->
            ...
            <div class="row align-items-center justify-content-center h-100 g-0">
                <div class="col col-sm-6 col-lg-7 col-xl-6">
                    ...
                    <a href="#" class="d-flex justify-content-center mb-4" >
                        <img src="images/buildings.png" alt="" width="60" style=" background: linear-gradient(rgba(0,0,0,0.7),rgba(0,0,0,0.7));border-radius:50%">
                    </a>
                    <!-- / Logo -->
                    ...
                    <form method="post" action="login">
                        ...
                        <button class="btn btn-outline-custom-login w-100 mb-3" style="background-color: #273036;color: white;">Login</button>
                    </form>
                    <!-- / Form -->
